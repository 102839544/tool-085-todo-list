...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 待办事项工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "todo-list".lower() or "clock" in "todo-list".lower():
            self.setup_timer_ui(main)
        elif "random" in "todo-list".lower() or "dice" in "todo-list".lower() or "coin" in "todo-list".lower():
            self.setup_random_ui(main)
        elif "note" in "todo-list".lower() or "todo" in "todo-list".lower():
    ...
    def generate_random(self):
        if "dice" in "todo-list".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "todo-list".lower():
